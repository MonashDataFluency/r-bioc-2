...
* Most of the packages used in this workshop have vignettes.

* The [file format FAQ](https://genome.ucsc.edu/FAQ/FAQformat.html) by UCSC. Mentioned in this workshop are GTF, GFF, BAM, bigWig. Also see [FASTA](https://en.wikipedia.org/wiki/FASTA_format) for sequences. [samtools (htslib)](http://www.htslib.org/) can make an index for many of these file types, for fast access by genome browsers and other software.
