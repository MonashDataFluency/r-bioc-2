...
**0-based:** Python, C, [UCSC file formats](https://genome.ucsc.edu/FAQ/FAQformat.html) such as BED
...
**1-based:** R, GFF and GTF feature files, SAM alignment files
...
<br>Need to do own conversion if using `read.table()`, etc.
